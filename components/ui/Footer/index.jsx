    ...
    const socialInfo = [
        {
            ...
            href: "https://m.facebook.com/61558234342706/"
        },
        {
            ...
            href: "https://x.com/fhreal_estate/"
        },
        {
            ...
            href: "https://www.linkedin.com/company/fine-home-real-estate"
        },
    ];
                ...
                <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                    <div>
                        ...
                        <div className="mt-4 space-y-2 text-sm text-gray-600">
                            <p>Office 3706, Addax Tower</p>
                            <p>Reem Island, Abu Dhabi, UAE</p>
                            <p>Phone: +971562993923</p>
                            <p>
    Business Address: <br />
    أبوظبي, أبوظبي<br />
    ...
    ق: 12C_1C
                ...
                <div className="mt-10 py-10 border-t">
                    <p className="text-center text-gray-600">
                        Copyright ©️ 2025. FINE HOME REAL ESTATE LLC. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
